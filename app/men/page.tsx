...
const products = [
  { id: 1, name: "Midnight Essence", price: "₹89", notes: "Woody, Spicy", intensity: "High", slug: "midnight-essence" },
  { id: 2, name: "Shadow", price: "₹79", notes: "Woody, Amber", intensity: "Medium", slug: "shadow" },
  { id: 3, name: "Obsidian", price: "₹99", notes: "Spicy, Oriental", intensity: "High", slug: "obsidian" },
  { id: 4, name: "Noir", price: "₹85", notes: "Citrus, Woody", intensity: "Medium", slug: "noir" },
  { id: 5, name: "Eclipse", price: "₹95", notes: "Amber, Musk", intensity: "High", slug: "eclipse" },
  { id: 6, name: "Twilight", price: "₹79", notes: "Fresh, Citrus", intensity: "Low", slug: "twilight" },
  { id: 7, name: "Phantom", price: "₹89", notes: "Leather, Tobacco", intensity: "High", slug: "phantom" },
  { id: 8, name: "Venom", price: "₹99", notes: "Spicy, Animalic", intensity: "High", slug: "venom" },
]
...
export default function MenPage() {
  ...
  const allNotes = ["Citrus", "Woody", "Spicy", "Amber", "Fresh", "Leather", "Tobacco", "Musk", "Oriental"]
        ...
        <section className="relative mb-16 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center py-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 glass-card rounded-full mb-6 scale-fade-in">
              ...
              <span className="text-xs font-space font-bold tracking-widest gradient-text">FOR HIM</span>
            </div>
            ...
            <p className="text-xl text-muted-foreground font-dm max-w-2xl mx-auto slide-in-bottom" style={{ animationDelay: "0.1s" }}>
              Modern fragrances built for confidence and presence.
            </p>
          </div>
        </section>
