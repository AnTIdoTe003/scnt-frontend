...
const products = [
  { id: 1, name: "Night Bloom", price: "₹95", notes: "Floral, Citrus", intensity: "Medium", slug: "night-bloom" },
  { id: 2, name: "Velvet Rose", price: "₹89", notes: "Floral, Woody", intensity: "High", slug: "velvet-rose" },
  { id: 3, name: "Moonlight", price: "₹79", notes: "Fresh, Floral", intensity: "Low", slug: "moonlight" },
  { id: 4, name: "Dusk", price: "₹99", notes: "Amber, Musk", intensity: "High", slug: "dusk" },
  { id: 5, name: "Enchant", price: "₹85", notes: "Oriental, Vanilla", intensity: "Medium", slug: "enchant" },
  { id: 6, name: "Whisper", price: "₹79", notes: "Citrus, Musky", intensity: "Low", slug: "whisper" },
  { id: 7, name: "Seduction", price: "₹95", notes: "Floral, Spicy", intensity: "High", slug: "seduction" },
  { id: 8, name: "Passion", price: "₹99", notes: "Oriental, Floral", intensity: "High", slug: "passion" },
]
...
export default function WomenPage() {
  ...
  const allNotes = ["Citrus", "Floral", "Woody", "Amber", "Fresh", "Musk", "Vanilla", "Oriental", "Spicy"]
        ...
        <section className="relative mb-16 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center py-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 glass-card rounded-full mb-6 scale-fade-in">
              ...
              <span className="text-xs font-space font-bold tracking-widest gradient-text">FOR HER</span>
            </div>
            ...
            <p className="text-xl text-muted-foreground font-dm max-w-2xl mx-auto slide-in-bottom" style={{ animationDelay: "0.1s" }}>
              Elegant compositions with depth, comfort, and staying power.
            </p>
          </div>
        </section>
