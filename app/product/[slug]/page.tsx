      ...
      <main className="pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-14 mb-20">
            {/* Product Gallery (reference-style) */}
                      ...
                      <div className="relative flex-1">
                        <div className="relative w-full aspect-square rounded-2xl overflow-hidden border border-border bg-card">
                          <Image
                            ...
                            priority
                          />
                          {/* Money-back badge (like reference) */}
            ...
            <div className="flex flex-col slide-in-bottom">
              {/* Title / rating / category pills (reference-style) */}
              <div className="mb-6">
              ...
              {/* Add to Cart (reference-style wide bar) */}
              <button className="w-full h-14 bg-primary text-primary-foreground rounded-xl font-space font-bold text-sm tracking-widest hover:opacity-95 transition">
                ADD TO CART
              </button>

              {/* Risk-free panel (reference-style) */}
              <div className="mt-5 rounded-2xl border border-border bg-secondary/40 p-6">
                ...
                <div className="text-center text-[11px] text-muted-foreground font-dm mt-5">
                  For help, email us at <span className="font-semibold">support@scnt.in</span>
                </div>
              </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {product.topNotes.map((note) => (
                        <span
                          key={note}
                          className="px-3 py-1 bg-secondary rounded-full text-xs font-dm border border-border"
                        >
                          {note}
                        </span>
                      ))}
          ...
          <section className="border-t border-primary/20 pt-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {product.recommendations.map((rec) => (
                <ProductCard key={rec.slug} name={rec.name} price={rec.price} notes="Premium Fragrance" slug={rec.slug} />
              ))}
            </div>
          </section>
        </div>
